...
def manipula_dados_contatos(contato: dict, conn):
    """
    ...
    contato_info = {
        ...
        "id_situacao_contato": db_pega_um_elemento("contatos_situacao",
                                                   "sigla",
                                                   contato["situacao"],
                                                   ["id"], conn)["id"],
        ...
        "id_tipo_contato": db_pega_um_elemento("contatos_tipo", "sigla",
                                               contato["tipo"], ["id"],
                                               conn)["id"],
        ...
        "email": contato["email"],
        "data_nascimento": formata_data(contato["dadosAdicionais"]
                                        ["dataNascimento"]),
